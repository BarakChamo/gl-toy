...
class ShaderFrame {
	constructor(tex, frag, canvas, params = {}, updateHook = noOp) {
		this.position = 0.0
		this.target = 0.0
		this.duration = 1.0
		...
		this.shader = Shader(this.gl, vert, frag[0])
		this.updateHook = updateHook

		// configure shader
		this.shader.attributes.position.location = 0
		console.log({...frag[1], ...params})
...
window.ShaderFrame = ShaderFrame
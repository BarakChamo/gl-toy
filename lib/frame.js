...
class ShaderFrame {
	...
	**/ 
	...
	setTarget = (to, duration) => {
		if(debug) console.info('Shader Frame: Target set.', to, duration)
	...
	**/ 
	enter(duration = 2000) {
		if(debug) console.info('Shader Frame: Enter.')
	...
	exit(duration = 2000) {
		if(debug) console.info('Shader Frame: Exit.')
